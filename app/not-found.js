        ...
        <div className="flex-1">
          <div className="w-[55%] flex flex-col h-full">
            ...
            <div className="flex-1 flex items-end">
              <div>
                <button
                  className="bg-white text-gray-700 p-1 font-medium px-6 rounded-lg text-lg"
                  type="button"
                >
                  Back
                </button>
                <button
                  className="bg-opacity-0 text-slate-300 p-1 font-medium px-6 rounded-lg text-lg border-[1px] border-slate-300 ml-3"
                  type="button"
                >
                  Home
                </button>
